package com.example.springboot.functionalprogramming.lambda;
...
public class ComparatorLambda {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Result of the comparator Prior JAVA 8 is :" + comparator.compare(2,2));
        System.out.println("Result of the comparator Prior JAVA 8 is :" + comparator.compare(3,2));
        System.out.println("Result of the comparator Prior JAVA 8 is :" + comparator.compare(1,2));

        /**
         * In JAVA 8
         */
        Comparator<Integer> comparatorLambda = (Integer  a,Integer b) -> a.compareTo(b);
        System.out.println("Result of the comparator using lambda is :" + comparatorLambda.compare(2,2));
        Comparator<Integer> comparatorLambda1 = (a,b) -> a.compareTo(b);
        System.out.println("Result of the comparator using lambda is :" + comparatorLambda1.compare(1,2));

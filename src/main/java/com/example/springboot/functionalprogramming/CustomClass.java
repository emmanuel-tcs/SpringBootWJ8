...
public class CustomClass {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("All Match Courses with Score Greater Than 95: " + courses.stream().allMatch(reviewScoreGreaterThan95Predicate));

        System.out.println("None Match Courses with Score Greater Than 90: " + courses.stream().noneMatch(reviewScoreLessThan90Predicate));

        System.out.println("Any Match Courses with Score Less Than 90: " + courses.stream().anyMatch(reviewScoreLessThan90Predicate));

        System.out.println("Any Match Courses with Score Greater Than 95: " + courses.stream().anyMatch(reviewScoreGreaterThan95Predicate));

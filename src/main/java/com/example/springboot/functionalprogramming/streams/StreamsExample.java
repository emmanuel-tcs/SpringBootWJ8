...
*/
        ...
        System.out.println("studentMap with gradePredicate : " + studentMap);
        ...
        System.out.println("studentMap with gpaPredicate : " + studentMap2);

        Map<String,List<String>> studentMap3 = StudentDataBase.getAllStudents().stream() //.parallelStream dont forger.
                .peek((student -> {
        ...
        System.out.println("studentMap with gpaPredicate and gradePredicate : " + studentMap3);
